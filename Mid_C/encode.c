...
char input_encode [50] = "abc ddd ada\0"; // message to encode
char encode_output [50] = ""; // message to decode
...
// the function to print the output message
...
// function to get the input characters and frequency, print the decode version
void HuffmanCodes(char input[], int freq[], int size) {
	...
	printf("Encode output: %s \n",encode_output); // Print encode version
    //printf("Decode version: %s",Decode(root,encode_output)); // Print decode version
}
